...
export const HISTORICAL_PLACES_MOCK_DATA:IDetailsInfoCard[] =[
    {
        mainTitle:'Jinnah Tower',
        image:'/assets/Jinnah_tower.jpg',
    ...
    },
    {
        ...
        image:'/assets/kondavidu_fort.jpeg',
    ...
    {
        mainTitle:'Uppalapadu Bird Sanctuary',
        image:'/assets/uppalapadu_sanctuary.jpeg',
...
export const RELIGIOUS_PLACES_MOCK_DATA:IDetailsInfoCard[] =[
    {
        mainTitle:'Mastan Vali Dargah ',
        image:'/assets/mastan_vali_dargah.jpeg',
    ...
    {
        mainTitle:'Pedakakani Sivalayam (Sri Malleswara Swami Temple)',
        image:'/assets/pedakakani_shivalayam.jpeg',
    ...
    {
        mainTitle:'Pedakakani Baji Baba Dargah',
        image:'/assets/pedakakani_baji_baba_dargah.jpeg',
    ...
    {
        mainTitle:'Sri Panakala Lakshmi Narasimha Swamy Temple (Mangalagiri)',
        image:'/assets/panakala_lakshmi_narasimha_temple.jpeg',
    ...
    {
        mainTitle:'Amaralingeswara Swamy Temple',
        image:'/assets/amara_lingeswara_temple.jpeg',
    ...
    {
        mainTitle:'Kotappakonda (Trikoteswara Swamy Temple)',
        image:'/assets/kotappa_konda.jpeg',
