  ...
  return (
    <div>
      ...
      <div className=' container'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 border-2 border-red-600'>
          <div>
