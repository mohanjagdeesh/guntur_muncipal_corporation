...
import { CONTACT_US_GRID_PROPS } from '../contact-us/ContactUs.tsx';
    ...
    <div className="container">
      <div className="flex flex-col md:flex-row items-start gap-5 my-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-4">
          {CONTACT_US_GRID_PROPS.data.map((each: any, index: number) => (
            <div
              key={index}
              className={`${
                index === 0 ? 'lg:col-span-2' : ''
              } border p-4 bg-white rounded-md shadow-md border-b-4 border-violet`}
            >
