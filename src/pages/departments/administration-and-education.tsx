...
import { ADMINISTRATION_LIST_ITEMS, EDUCATION_ADMINISTRATION_LIST_ITEMS, EDUCATION_LIST_ITEMS } from '../../mock-data/departments-list-items-mock-data.ts';
