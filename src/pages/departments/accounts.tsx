  ...
  return (
    <div>
        ...
        <div className='container'>
          <DepartmentsDataRenderer description={`The Accounts Department in a Municipal Corporation plays a crucial role in managing the financial health of the corporation. Here are the key functions of the Accounts Department:`} liRenderer={REVENUE_FM_OF_LIST_ITEMS.map((each)=>(<RenderListItems {...each} />))} departmentImage='/assets/accounts.jpg' />
