  ...
  return (
    <>
        ...
        <div className='container'>
          <DepartmentsDataRenderer liRenderer={UPA_CELL_LIST_ITEMS.map((each)=>(<RenderListItems {...each} />))} dataGrid={<GridReport {...upaCellGridProps}  />} departmentImage='/assets/administration_education.jpg' />
        </div>
    </>
  )
}
