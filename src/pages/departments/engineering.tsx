  ...
  return (
    <div>
        ...
        <div className='container'>
          <DepartmentsDataRenderer description={`The Town Planning Department in a Municipal Corporation plays a crucial role in shaping the physical development of a city. Here are its key functions:`} liRenderer={REVENUE_FM_OF_LIST_ITEMS.map((each)=>(<RenderListItems {...each} />))} departmentImage='/assets/engineering.jpg' />
